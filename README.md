...
After the installation, the API can be accessed at http://invoiceapi-rpgn.onrender.com/api. You can use tools like [Postman](https://www.postman.com/downloads/) or other similar applications to interact with the endpoints.
